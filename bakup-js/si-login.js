...
SI_LOGIN.init = function(mainContainer) {
	...
	SI_LOGIN.skeleton = '<div class="si-page-bg si-login__page"> <div class="si-main__container"> <div class="si-login__form"> <div class="si-login__left"></div><div class="si-login__Logo"> <img src="'+logoImage+'"> <span> <em class="si-text">Welcome To Highlights Dashboard</em></span> </div><div class="si-login__right"> <div class="si-login__head"> <span class="si-title">Login</span> <span class="si-subtitle">to your account</span> </div><div class="si-login__input"> <form action=""> <div class="si-username"> <input type="text" name="" id="username" placeholder="Username"> <div class="si-frm-errMsg"><span class="username-error" style="display:none">Please enter username.</span></div></div><div class="si-password"> <input  type="password" name="" id="password" placeholder="Password"> <div class="si-frm-errMsg"><span class="password-error" style="display:none">Please enter password</span></div></div><div class="si-forgetPass"> </div><div class="si-commonerror si-credential-error" style="display:none;"> <span>Invalid Credential </span> </div><div class="si-login__button"> <button type="button" class="si-btn2 si-login"> <span>Login</span> </button> </div></form> </div></div></div></div></div>';
