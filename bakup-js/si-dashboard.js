...
SI_DASHBOARD.init = function(mainContainer) {
	SI_DASHBOARD.skeleton = '<div class="si-page-bg si-highlight"> <div class="si-header si-header-content"> </div><div class="si-bottombg"> <div class="si-drpwrpper si-dropdown-content"> <div class="si-drpDwn"> <label class="si-label si-sport-label">SPORT </label> <div class="si-drpDwn__value"> <select disabled="true"> <option>Cricket</option>  </select> </div></div><div class="si-drpDwn"> <label class="si-label">SERIES </label> <div class="si-drpDwn__value"> <select disabled="true" id="si-series-label"> <option>Select</option> <option>Dropdown Value</option> </select> </div></div><div class="si-drpDwn"> <label class="si-label">Match </label> <div class="si-drpDwn__value"> <select id="match_options"> <option>Select</option> </select> </div></div></div><div class="si-highlightwrp"> <div class="si-left si-left-highlight-cont" style="display:none"> <div class="tab"> <span>Highlight Events</span> </div><div class="si-inside-wrpper"> <div class="si-cover"> <label class="si-label">Type </label> <div class="si-drpDwn"> <div class="si-drpDwn__value"> <select id="highlightType"> <option value="">Highlight Type</option> <option value="1">Inning 1</option> <option value="2">Inning 2</option> <option value="3">Full Match</option> </select> </div></div></div><div class="si-cover"> <label class="si-label">Duration</label> <div class="si-drpDwn"> <div class="si-drpDwn__value"> <select id="highlightLength"> <option value="">Select</option> <option value="101">Optimal Clip</option> <option value="2">1-3 mins</option> <option value="4">3-5 mins</option> <option value="6">5-7 mins</option> <option value="8">7-9 mins</option> <option value="10">9-11 mins</option> <option value="12">11-13 mins</option> <option value="14">13-15 mins</option> <option value="16">15-17 mins</option> <option value="18">17-19 mins</option> <option value="20">19-21 mins</option> <option value="22">21-23 mins</option> <option value="24">23-25 mins</option> </select> </div></div></div></div><div class="si-tableContainer"> <div class="si-tbls"> <div class="si-tbls__head"> <div class="si-tbls__row"> <div class="si-tbls__cell si-eventname"> <span>Events</span> </div><div class="si-tbls__cell si-duration"> <span class="si-icon si-clock"></span> <span>Duration</span> </div></div></div><div class="si-tbls__body"> <div class="swiper-container swiper-contain3 "> <div class="swiper-wrapper si-swiper-tab3-content"> </div><div class="swiper-scrollbar swiper-scroll "> </div></div></div></div></div></div><div class="si-right"> <div class="si-maincover si-maincover-content"> </div></div></div></div></div>';
...
SI_DASHBOARD.loadMatches = function(mainContainer) {
	var matchUrl = SI_HGLT_DSBRD.feedBasePath + 'api/FillMatches/1/1';
